...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleMapsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>services</b> with <b>com.google.maps:google-maps-services</b> coordinates and
         * with version reference <b>googleMapsServices</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getServices() {
            return create("google.maps.services");
        }
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>places</b> with <b>com.google.android.gms:play-services-places</b> coordinates and
         * with version reference <b>playServicesPlaces</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getPlaces() {
            return create("play.services.places");
        }
    ...
    public static class PlayServicesMapsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v1801</b> with <b>com.google.android.gms:play-services-maps</b> coordinates and
         * with version reference <b>playServicesMapsVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getV1801() {
            return create("play.services.maps.v1801");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidMapsUtils</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleMapsServices</b> with value <b>2.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGoogleMapsServices() { return getVersion("googleMapsServices"); }
        ...
        /**
         * Version alias <b>playServices</b> with value <b>11.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesMapsVersion</b> with value <b>18.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesPlaces</b> with value <b>11.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesPlaces() { return getVersion("playServicesPlaces"); }
    ...
    public static class ConverterVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>converter.gson</b> with value <b>2.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class LoggingVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>logging.interceptor</b> with value <b>5.0.0-alpha.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
